...
// integrationInputJSON is the shared MCP server card fixture for all integration tests.
var integrationInputJSON = testutils.LoadFixture("testdata/mcp_server_card.json")
...
func TestIntegration_Merge_Root_AddsStateInfo(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("merge_root_expected.json"),
...
func TestIntegration_Update_Root_ReplacesEntireDocument(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("update_root_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"update",
			model.Selector{Root: utils.Ptr(true)},
			map[string]any{
...
func TestIntegration_Remove_Root_ClearsDocument(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("remove_root_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"remove",
			model.Selector{Root: utils.Ptr(true)},
			nil,
...
func TestIntegration_Merge_JSONPath_BumpsVersionAndAddsOrdId(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("merge_jsonpath_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"merge",
...
func TestIntegration_Update_JSONPath_ReplacesMeta(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("update_jsonpath_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"update",
...
func TestIntegration_Remove_JSONPath_RemovesPrompts(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("remove_jsonpath_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"remove",
...
func TestIntegration_Merge_JSONPath_UpdatesToolDescription(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("merge_jsonpath_tool_description_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"merge",
...
func TestIntegration_Update_JSONPath_ReplacesToolInputSchema(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("update_jsonpath_tool_inputschema_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"update",
...
func TestIntegration_Remove_JSONPath_RemovesResources(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("remove_jsonpath_resources_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"remove",
...
func TestIntegration_Merge_JSONPath_EnrichesResource(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("merge_jsonpath_resource_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"merge",
...
func TestIntegration_Update_JSONPath_ReplacesRemoteEndpoint(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("update_jsonpath_remotes_expected.json"),
		applyIntegration(t, testutils.OnePatch(
			"update",
...
func TestIntegration_MultiPatch_RealisticOverlaySequence(t *testing.T) {
	testutils.AssertDeepEquals(
		t,
		loadIntegrationExpected("multi_patch_expected.json"),
